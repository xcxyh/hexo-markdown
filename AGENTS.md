...
[![Codex](https://img.shields.io/badge/Powered_by-Codex-0081CB?style=for-the-badge&logo=anthropic&logoColor=white)](https://Codex.ai/)
...
本文档介绍如何在 Hexo 博客项目中使用 Codex 进行高效的博客管理和内容创作。
...
Codex 是 Anthropic 官方的 CLI 工具，专为软件开发设计，具有以下特点：
...
创建 `.Codex-workflows` 目录，定义常用的工作流：
...
- [Codex 官方文档](https://docs.anthropic.com/Codex/code)
- [Hexo 官方文档](https://hexo.io/docs/)
- [Fluid 主题文档](https://fluid-dev.github.io/hexo-theme-fluid/)
- [VSCode Codex 扩展](https://marketplace.visualstudio.com/items?itemName=anthropic.Codex)

---

> 💡 **提示**：善用 Codex 可以显著提高博客管理效率，让你更专注于内容创作而非技术细节。